...
contract CollectorRecollatStates is AtmosProtocol {
    ...
    uint256 public bonusRate = 5000; // Bonus rate on ATM minted during recollateralize(); 6 decimals of precision
    mapping(uint256 => uint256) public rctHourlyCum; // Epoch hour ->  ATM out in that hour
